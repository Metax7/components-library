...
import type { JewelriesParams, StonesParams, BookmarksParams, QuotesParams } from "../hooks/use-data"
  ...
  return {
    ...
    bookmarks: {
      findMany: async (params?: BookmarksParams) => {
        ...
        try {
          return await api.bookmarks.findMany(params)
        } catch (error) {
          console.error(error)
          return null
        }
    ...
    jewelries: {
      findMany: async (params?: JewelriesParams) => {
        ...
        try {
          return await api.jewelries.findMany(params)
        } catch (error) {
    ...
    stones: {
      findMany: async (params?: StonesParams) => {
        ...
        try {
          return await api.stones.findMany(params)
        } catch (error) {
    ...
    quotes: {
      findMany: async (params?: QuotesParams) => {
        ...
        try {
          return await api.quotes.findMany(params)
        } catch (error) {
